...
export const Body = async ({ id }) => {
    ...
    const filename = process.env.API_URL + '/Blog/getImagen/' + blog.id;
    console.log(process.env.API_URL + '/Blog/getImagen/' + blog.id);
    return (
            ...
            <div className="p-2">
                <div className="w-full m-2 p-2">
                    ...
                    <div className="w-full border p-2 m-2">
                        ...
                        <img src={`${filename}`} alt="" srcSet="" title={blog.titulo} className="object-cover w-full" />
                    </div>
                    < div className="mt-5 text-center">
                        {blog.link != null && (
                            <a href={"https://" + blog.link} className="p-3 m-2 bg-blue-600 hover:bg-blue-400 text-white" target="_blank" title={blog.titulo} rel="noopener noreferrer">
                                Ir A {blog.titulo}
                            </a>
                        )}
                    </div>
