...
<div class="p-4">
  <div class="flex justify-between">
    <div class="text-xl pt-4 pl-4 pr-4 font-semibold">Crear Nuevo Post en
  ...
  <br>
  <hr class="text-black">
  <form action="{{ route('guardar_post') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="space-y-2">
      <div class="flex">
        <div class="border-b border-gray-900/10 pb-12 w-1/2 p-4">
         ...
         text-gray-900 placeholder:text-gray-400 rounded-sm ring-2 hover:ring-blue-700 " required placeholder="Ingresa el Titulo del Post">
        </div>
        <div class="border-b border-gray-900/10 pb-12 w-1/2 p-4">
         ...
         text-gray-900 placeholder:text-gray-400 rounded-sm ring-2 hover:ring-blue-700 " required placeholder="Ingresa el Subtitulo del Post">
        </div>
      </div>
      <div class="border-b border-gray-900/10 pb-0">
        ...
        <div class="flex justify-between ">
          ...
          @if(session('mensaje'))
          <div class="bg-{{ session('estado') === 'success' ? 'green' : 'red' }}-500 text-white p-4 rounded-md font-semibold" id="mensajeDiv">
            <p>{{ session('mensaje') }}</p>
          </div>
          <script>
        ...
        <div class="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 ">
          <div class="sm:col-span-3">
            ...
            <div class="mt-2">
              <textarea type="text" rows="5" name="descripcion" id="descripcion" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
              </textarea>
            </div>
          </div>
          <div class="md:flex grid grid-cols-1 md:justify-between">
            <div class="col-span-4 md:w-1/3  w-full p-3 my-auto">
              ...
              <div class="mt-2">
                <input id="imagen" name="imagen" type="file" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
              </div>
            </div>
            <div class="col-span-4 md:w-1/3 w-full p-3 my-auto">
              <label for="fecha" class="block text-sm font-medium leading-6 text-gray-900">Fecha</label>
              <input id="fecha" name="fecha" type="date" value="{{ Carbon\Carbon::now('America/Lima')->toDateString() }}" required class="block w-full rounded-md cursor-pointer mt-2 border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            ...
            <div class="col-span-4 md:w-1/3 w-full p-3 my-auto">
              ...
              <input id="link" name="link" type="text" placeholder="www.example.com" required class="block w-full rounded-md  mt-2 border-0 p-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
    ...
    <div class="mt-6 flex items-center justify-end gap-x-6">
      <button type="reset" class="text-sm font-semibold leading-6 text-gray-900">Cancelar</button>
